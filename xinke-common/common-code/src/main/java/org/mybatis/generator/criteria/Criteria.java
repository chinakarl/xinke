package org.mybatis.generator.criteria;

import org.apache.commons.lang3.StringUtils;
import org.mybatis.generator.page.Page;
import org.mybatis.generator.page.PageCondition;
...
public class Criteria extends PageCondition
{
    ...
    public static class Condition implements Serializable {
        ...
        protected void addCriterion(final String condition, final Object value, final String property) {
            if (value == null) {
                // throw new BaseRuntimeException("Value for " + property +
                // " cannot be null");
                return;
            }
        ...
        protected void addCriterion(final String condition, final Object value1, final Object value2, final String property) {
            if ((value1 == null) || (value2 == null)) {
                // throw new BaseRuntimeException("Between values for " + property +
                // " cannot be null");
                return;
            }
        ...
        /**
        * @Title: andColumnEqualTo
        * @Description: 两列值相等
        * @param columnName1
        * @param columnName2
        * @return
         */
        public Condition andColumnEqualTo(final String columnName1, final String columnName2) {
            addCriterion(columnName1 + " = " + columnName2);
            return this;
        }
        
        /**
         * @Title: andColumnNotEqualTo
         * @Description: 两列值不相等
         * @param columnName1
         * @param columnName2
         * @return
          */
         public Condition andColumnNotEqualTo(final String columnName1, final String columnName2) {
             addCriterion(columnName1 + " != " + columnName2);
             return this;
         }
         ...
         * @name 中文名称
         * @Description 相关说明
         * @Time 创建时间:2015-2-6下午9:21:47
         * @param columnName
         * @return Condition mysql使用此方法
         * @history 修订历史（历次修订内容、修订人、修订时间等）
         */
        public Condition andSysdateBetween(final String columnName, final String columnName2) {
            addCriterion(" sysdate() between " + columnName + " and " + columnName2);
            return this;
        }
         ...
         * @return 增加条件后的条件类对象
         */
        public Condition andIn(final String columnName, final List<?> values) {
         ...
         * @return 增加条件后的条件类对象
         */
        public Condition andNotIn(final String columnName, final List<?> values) {
            if ((values != null) && (values.size() > 0)) {
        ...
        public Condition andLikeInsensitive(final String columnName, final String value) {
            if (StringUtils.isNotBlank(value)) {
                addCriterion(UPPER_LEFT + columnName + UPPER_RIGHT, value == null ? null : ANY_MATCH + value.toUpperCase() + ANY_MATCH, columnName);
            }
            return this;
        }
        ...
        public Condition andLeftLikeInsensitive(final String columnName, final String value) {
            if (StringUtils.isNotBlank(value)) {
                addCriterion(UPPER_LEFT + columnName + UPPER_RIGHT, value == null ? null : value.toUpperCase() + ANY_MATCH, columnName);
            }
            return this;
        }
        ...
        public Condition andRightLikeInsensitive(final String columnName, final String value) {
            if (StringUtils.isNotBlank(value)) {
                addCriterion(UPPER_LEFT + columnName + UPPER_RIGHT, value == null ? null : ANY_MATCH + value.toUpperCase(), columnName);
            }
            return this;
        }
    }

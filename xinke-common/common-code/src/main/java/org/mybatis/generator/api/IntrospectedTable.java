/*
 * Copyright 2006 The Apache Software Foundation Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in
...
/**
 * Base class for all code generator implementations. This class provides many of the housekeeping methods needed to implement a code generator, with
 * only the actual code generation methods left unimplemented.
 * @author Jeff Butler
 */
public abstract class IntrospectedTable {
    ...
    /**
     * Returns the columns in the primary key. If the generatePrimaryKeyClass() method returns false, then these columns will be iterated as the
    ...
    /**
     * @return the type for the record (the class that holds non-primary key and non-BLOB fields). Note that the value will be calculated regardless
     *         of whether the table has these columns or not.
     */
    ...
    /**
     * @return the type for the record with BLOBs class. Note that the value will be calculated regardless of whether the table has BLOB columns or
     *         not.
     */
    ...
    /**
     * Calculates an SQL Map file name for the table. Typically the name is "XXXX_SqlMap.xml" where XXXX is the fully qualified table name (delimited
     * with underscores).
    ...
    protected void calculateXmlAttributes() {
        ...
        setExampleWhereClauseId("common.Example_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("common.Update_By_Example_Where_Clause"); //$NON-NLS-1$
    }
    ...
    /**
     * This method can be used to initialize the generators before they will be called. This method is called after all the setX methods, but before
    ...
    /**
     * This method should return a list of generated Java files related to this table. This list could include various types of model classes, as well
     * as DAO classes.
    ...
    /**
     * This method should return a list of generated XML files related to this table. Most implementations will only return one file - the generated
     * SqlMap file.
    ...
    /**
     * Should return true if an XML generator is required for this table. This method will be called during validation of the configuration, so it
     * should not rely on database introspection. This method simply tells the validator if an XML configuration is normally required for this
     * implementation.
     * @return
     */
